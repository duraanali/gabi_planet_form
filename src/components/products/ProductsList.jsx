...
function ProductsList(props) {
  ...
  return (
    <div className="flex flex-row flex-wrap p-20 justify-center items-center min-h-screen bg-gray-200">
    {props.products.map((product) =>
        ...
        <div className="px-4 py-3 w-72">
            ...
            <span className="text-gray-400 mr-3 text-xs">{product.description}</span>
